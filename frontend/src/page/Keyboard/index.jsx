...
function Mouse() {
  ...
  useEffect(() => {
    const fetch = async () => {
      const response = await request1.get("goods/5/getByCategoryId");
      ...
      <div className="flex divide-y divide-gray-100 rounded-lg my-10">
        ...
        <div className="z-10 font-normal basis-[20%]">
          <ul className="py-2 dark:text-gray-400 font-Montserrat font-semibold">
            ...
            <li className="pt-4">
              <Link className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-primary" to={"/keyboard/logitech"}>
              Logitech 
              </Link>
            </li>
            <li>
              <Link className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-primary" to={"/keyboard/microsoft"}>
                Microsoft
              </Link>
            </li>
            <li>
              <Link className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-primary " to={"/keyboard/rapoo"}>
                Rapo
              </Link>
            </li>
          </ul>
